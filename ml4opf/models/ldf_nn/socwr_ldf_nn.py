...
from ml4opf.models.basic_nn.socwr_basic_nn import SOCWRBasicNN, SOCWRBasicNeuralNet
from ml4opf.loss_functions.objective import ObjectiveLoss
from ml4opf.formulations.socwr import SOCWRViolation, SOCWRModel


class SOCWRLDFNN(LDFNN, SOCWRBasicNN):
...
class SOCWRLDFNeuralNet(LDFNeuralNet, SOCWRBasicNeuralNet):
    model: SOCWRLDFNN
